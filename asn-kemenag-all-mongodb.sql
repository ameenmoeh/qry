SELECT --TOP 100
    ...
    END AS TIPE_JABATAN, J.GRADE as KELAS_JABATAN, L.GRUP_SATUAN_KERJA,
    CONVERT(VARCHAR, GETDATE(),23) AS TGL_GEN
...
LEFT JOIN TM_GRUP_SATUAN_KERJA L ON A.KODE_GRUP_SATUAN_KERJA = L.KODE_GRUP_SATUAN_KERJA
