SELECT --TOP 100
    ...
    A.TEMPAT_LAHIR, CONVERT(VARCHAR, A.TANGGAL_LAHIR,23) AS TANGGAL_LAHIR, DATEDIFF(YEAR, A.TANGGAL_LAHIR, GETDATE()) AS USIA, 
    CASE 
    ...
    END AS GRUP_USIA,
    CONVERT(VARCHAR, A.MASUK_PEGAWAI,23) AS MASUK_PEGAWAI, IIF(A.JENIS_KELAMIN=0,'Perempuan','Laki-Laki') AS JENIS_KELAMIN, B.AGAMA, C.STATUS_KAWIN, 
    D.STATUS_PEGAWAI, E.JENIS_PEGAWAI, F.MUTASI, 
    GA.JENJANG_PENDIDIKAN, HA.PANGKAT, 
	CASE WHEN A.KODE_STATUS_PEGAWAI <> 3 THEN HA.GOL_RUANG ELSE HA.GOL_PPPK END GOL_RUANG,  
    H.MK_TAHUN AS MK_TAHUN_KP, H.MK_BULAN AS MK_BULAN_KP, 
    ...
    IA.JABATAN, IA.TAMPIL_JABATAN, IA.USIA_PENSIUN, 
    CAST(
    ...
    END AS TIPE_JABATAN, 
    IK.GRADE,
    S1.KODE_SATUAN_KERJA AS KODE_SATKER1, S1.SATUAN_KERJA AS SATKER1, 
    S2.KODE_SATUAN_KERJA AS KODE_SATKER2, S2.SATUAN_KERJA AS SATKER2,
    S3.KODE_SATUAN_KERJA AS KODE_SATKER3, S3.SATUAN_KERJA AS SATKER3, 
    S4.KODE_SATUAN_KERJA AS KODE_SATKER4, S4.SATUAN_KERJA AS SATKER4,
    ...
    IC.KETERANGAN_SATUAN_KERJA, ICC.GRUP_SATUAN_KERJA, TK.ALMARI
FROM            
...
WHERE A.KODE_MUTASI=3 AND
YEAR(A.TANGGAL_LAHIR)>1950
