SELECT A.NIP_BARU, A.NAMA_LENGKAP, CONVERT(VARCHAR, A.TMT_PENSIUN,23) AS TMT_PENSIUN, a.KODE_SATUAN_KERJA,
	E.SATUAN_KERJA AS SATKER1, D.SATUAN_KERJA AS SATKER2, A.SATUAN_KERJA, MUTASI
...
WHERE KODE_MUTASI IN ('1','2','3','12') AND YEAR(TMT_PENSIUN) IN ('2021','2022','2023')
